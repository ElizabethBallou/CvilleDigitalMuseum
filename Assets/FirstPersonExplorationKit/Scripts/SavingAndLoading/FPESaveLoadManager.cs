...
namespace Whilefun.FPEKit
{
    ...
    public class FPESaveLoadManager : MonoBehaviour
    {
        ...
        private GameObject loadingUIParentCanvas;
        ...
        private string autoSaveDirName = "auto";
        private string fullSaveDirName = "full";
        private string coreSaveFile = "core.dat";
        private string playerLocationDataSaveFile = "player.dat";
        private string inventoryDataSaveFile = "inventory.dat";
        private string optionsDataSaveFile = "options.dat";
        private string levelDataFilePrefix = "level_";
        private string levelDataFilePostfix = ".dat";
        // Base paths
