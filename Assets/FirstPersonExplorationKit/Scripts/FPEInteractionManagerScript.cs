...
namespace Whilefun.FPEKit
{
    ...
    public class FPEInteractionManagerScript : MonoBehaviour
    {
        ...
        [Tooltip("When examining an object, this value acts as a multiplier to Input Mouse X/Y values. Default is 150.")]
        public float examineRotationSpeed = 150.0f;
       ...
       /* public void hideAudioDiaryTitle()
        ...
        private void moveObjectToPlayersHand(GameObject go)
        {
            ...
            Debug.Log("interactionObjectPickupLocation is " + interactionObjectPickupLocation.transform.position);
